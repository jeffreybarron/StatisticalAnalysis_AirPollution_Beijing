...
if (savePNG){png(filename = "dongsihuan_dataFreq_pMonth.png",
    width = 480, height = 480, units = "px", pointsize = 12)} 

barplot(Dongsihuan_stats$n,
        main="Datum Frequency per Month",
        names.arg = Dongsihuan_stats$name,
        sub="Question: Why does frequency drop-off from Sept-2015?",
...
library(corrplot)
if (savePNG){png(filename = "dongsihuan_correlation_matrix.png",
                 width = 480, height = 480, units = "px", pointsize = 12)}
...
if (savePNG){png(filename = "dongsihuan_pairs_scattergram.png",
                 width = 480, height = 480, units = "px", pointsize = 12)}
...
if (savePNG){png(filename = "dongsihuan_attributeVPM_scattergrams.png",
                 width = 480, height = 480, units = "px", pointsize = 12)}
...
p1 <- ggplot(data=Dongsihuan, aes(PM_Dongsihuan)) + geom_histogram(binwidth = 2) + labs(
  x = "PM2.5 Value",
  y = "Frequency",
  subtitle = "Histogram of PM2.5 Readings 2013-2015 for Dongsihuan, China")
p2 <- ggplot(data=Dongsihuan, aes(DEWP)) + geom_histogram(binwidth = 2) + labs(
  x = "Temperature C",
  y = "Frequency",
  subtitle = "Histogram of Dew Point readings for Beijing, China 2013-2015")
p3 <- ggplot(data=Dongsihuan, aes(HUMI)) + geom_histogram(binwidth = 2) + labs(
  x = "Humidity (%)",
  y = "Frequency",
  subtitle = "Histogram of Humidity readings for Beijing, China 2013-2015")
p4 <- ggplot(data=Dongsihuan, aes(PRES)) + geom_histogram(binwidth = 2) + xlim(980,1050) + labs(
  x = "Pressure (hPa)",
  y = "Frequency",
  subtitle = "Histogram of Barometric Pressure readings for Beijing, China 2013-2015")
p5 <- ggplot(data=Dongsihuan, aes(TEMP)) + geom_histogram(binwidth = 2) + labs(
  x = "Temperature Centigrade (C)",
  y = "Frequency",
  subtitle = "Histogram of Temperature readings for Beijing, China 2013-2015")
...
p6 <- ggplot(data=na.omit(Dongsihuan), aes(cbwd)) + geom_histogram(stat = "count") + labs(
  ...
  y = "Frequency",
  subtitle = "Histogram of Combined wind direction (cbwd) readings for Beijing, China 2013-2015")

# now use multiplot to put them all on one page (requires user_functions.R)
if (savePNG){png(filename = "dongsihuan_weather_readings.png",
                 width = 480, height = 480, units = "px", pointsize = 12)}
...
# More Plots
if (savePNG){png(filename = "dongsihuan_grouped_plots.png",
                 width = 480, height = 480, units = "px", pointsize = 12)}
...
if (savePNG){png(filename = "dongsihuan_catagorical_plots.png",
                 width = 480, height = 480, units = "px", pointsize = 12)}
...
if (savePNG){png(filename = "dongsihuan_pm2.5_bygroup.png",
                 width = 480, height = 480, units = "px", pointsize = 12)}
...
if (savePNG){png(filename = "dongsihuan_pmByPeriodType.png",
                 width = 480, height = 480, units = "px", pointsize = 12)}
...
barplot(PM_ByWeekday$mean,
      main="Average PM2.5 p/Day of the week",
...
barplot(PM_ByWorkingHrs$mean,
      main="Average PM2.5 p/working vs non-working hours",
...
summary(lm(Bj.fit <-Beijing_PMRange ~ (HUMI + DEWP + PRES + TEMP + Iws + precipitation), 
           data = Bj))
summary(lm(Bj.fit <-Beijing_PMRange ~ (HUMI + DEWP + PRES + TEMP + Iws), 
           data = Bj))
summary(lm(Bj.fit <-Beijing_PMRange ~ (HUMI + DEWP + PRES + TEMP), 
           data = Bj))
summary(lm(Bj.fit <-Beijing_PMRange ~ (HUMI + DEWP + PRES), 
           data = Bj))
summary(lm(Bj.fit <-Beijing_PMRange ~ (HUMI + DEWP), 
           data = Bj))
summary(lm(Bj.fit <-Beijing_PMRange ~ (HUMI), 
           data = Bj))
summary(lm(Bj.fit <-Beijing_PMRange ~ (DEWP), 
           data = Bj))
